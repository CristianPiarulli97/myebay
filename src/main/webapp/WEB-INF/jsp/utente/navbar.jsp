    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/annuncio/search">Home</a>
          </li>
...
<%-- 
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown07">
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/annuncio/search">Home</a></li>
      ...
      <div class="col-md-3 text-end">
  				<p class="navbar-text">
   					     <a href="${pageContext.request.contextPath}/utente/areapersonale">Area Personale</a>
  				</p>
			</div>      
	      <div class="col-md-3 text-end">

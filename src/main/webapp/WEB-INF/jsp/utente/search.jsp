				...
				<div class='card-body'>
					...
					<form method="post"
						...
						<div class="col-md-6 form-check" id="ruoliDivId">
							<p>Ruoli:</p>
							<c:forEach var="ruolo" items="${ruoli_totali_attr}">
								<div class="form-check">
									<input class="form-check-input" type="checkbox"
										id="${ruolo.id}" name="ruoli" value="${ruolo.id}"> <label
										class="form-check-label" for="${ruolo.id}">${ruolo.codice}</label>
								</div>
							</c:forEach>
						</div>
						<div class="col-12">
							<button type="submit" name="submit" value="submit" id="myButton"
